# Financial Discovery — Core — Legal Authority Lab

**Suite:** Financial Discovery — Core  
**List price:** $5,000  
**Version:** 1.0.0  
**Publisher:** Legal Authority Lab — legalauthoritylab.com

Complete financial discovery pipeline: intake through ED chart, Rule 12.285 compliance, QC gates.

## Skills included

- `lal-discovery-router`
- `lal-financial-intake`
- `lal-disco-intake-prep`
- `lal-disco-organization`
- `lal-disco-tracker`
- `lal-fa-builder`
- `lal-fa-preliminary`
- `lal-fa-crosscheck`
...
- `lal-discovery-gap`
- `lal-ed-chart`
- `lal-cert-of-compliance`
- `lal-disco-qc`
- `lal-financial-prep-orchestrator`
- `lal-deep-scan`
- `lal-income-assessor`
